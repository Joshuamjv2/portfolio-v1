                ...
                <div className="flex items-center h-full">
                    <div className="">
                        ...
                        <p className="text-[#2b2d42] lg:text-base my-4 sm:block max-w-[800px]">
                            I’m a software engineer with a passion to solve problems through learning, creativity, and collaboration. I believe great solutions come from a blend of curiosity, creativity, and hard work and I am always ready to learn whatever is required to get work done.
                        </p>
